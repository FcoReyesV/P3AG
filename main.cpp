...
int main(int argc, char *argv[]){
    ...
    cin>>gn;
    pRuleta r(32,5,gn,3,3); //(int miembros,int genes,int generaciones,int pcruza,int mutar)
    ...
    cout<<"Archivos generados correctamente con los nombres: Tabla1.txt, Tabla2.txt y Tabla3.txt"<<endl;
    QLineSeries *series = new QLineSeries();
    QLineSeries *series2 = new QLineSeries();
    cout<<"Maximos"<<endl<<endl;
    ...
    chart->setTitle("Práctica 3: Selección por ruleta");
    ...
    axisX->setTickCount(r.generaciones);
    chartView->chart()->setAxisX(axisX, series);

    QValueAxis *axisX2 = new QValueAxis;
    axisX2->setRange(1, r.generaciones);
    axisX2->setTickCount(r.generaciones);
